...
files_exp = [{'files': 'density_exp_1mol.csv', 'mol': '1'},
...
files_tip4p=[ 
        {'files': 'density_tip4p_1.09mol_new.csv', 'mol': '1.09'},
        {'files': 'density_tip4p_2.17mol_new.csv', 'mol': '2.17'},
        {'files': 'density_tip4p_3.26mol_new.csv', 'mol': '3.26'},
        {'files': 'density_tip4p_4.34mol_new.csv', 'mol': '4.34'},
        {'files': 'density_tip4p_5.43mol_new.csv', 'mol': '5.43'},
            ]
Temp = [298,323,373]
...
for file_exp in files_exp:
    path_exp =os.path.join('./Exp_Density',file_exp['files'])
    '''
...
for file_tip4p in files_tip4p:
    path_tip4p =os.path.join('./Tip4p_Density',file_tip4p['files'])
...
for temp in Temp:
    ...
    plt.ylabel('Density, (g/m$^{3}$)',fontweight ='bold', fontsize = 8)
    plt.title(f'Density vs. Molality at {temp}K',fontweight ='bold', fontsize = 10)
    plt.legend()
    plt.show()
    plt.savefig('./png/Density_Mol_Exp_Tip4p/' + fpng)
    plt.close()
